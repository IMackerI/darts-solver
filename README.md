...
# Darts Solver Documentation

You can currently use this library in your web browser by visiting the interactive frontend at:

https://imackeri.github.io/darts-solver/
...
- **geometry** - 2D vectors and polygons for representing dartboards
- **distributions** - Probability distributions for modeling throwing accuracy
- **game** - Game rules and dartboard targets
- **solver** - Optimal strategy computation
...
_The web frontend (HTML, CSS, and JavaScript under `src/web/`) was generated
mostly by AI (GitHub Copilot) and serves as a thin UI layer over the C++ logic._
